...
/*  |- Mode name -|- Mode -|- Algo -| |------------------- OP KEY --------------------|  |-- PPID/Key num --|  |--- Date ----|   |------- Theme -----| Level |- "Channel name" -| */
        { "viasat220300040CAU", EC_M,    EC_M, { 0xE9, 0xF3, 0x34, 0x36, 0xB0, 0xBB, 0xF8 }, { 0x00, 0x04, 0x0C }, { "TODAY"      }, { THEME_ENTERTAINMENT, 0x00 }, "TV3 (M)" }, 
        { "viasat220300041CAU", EC_M,    EC_M, { 0xE9, 0xF3, 0x34, 0x36, 0xB0, 0xBB, 0xF8 }, { 0x00, 0x04, 0x1C }, { "TODAY"      }, { THEME_FILM,          0x00 }, "TV1000 (AU - M)" },      
        { "filmnet4528002808AU",EC_M,    EC_M, { 0x21, 0x12, 0x31, 0x35, 0x8A, 0xC3, 0x4F }, { 0x00, 0x28, 0x08 }, { "TODAY"      }, { THEME_FILM,          0x00 }, "FilmNet (M)" },
        { "cplusfr43AU",        EC_M,    EC_M, { 0x69, 0x41, 0x2D, 0x4C, 0x56, 0x28, 0xCF }, { 0x10, 0x00, 0x18 }, { "TODAY"      }, { THEME_FILM,          0x00 }, "Canal+ 4/3 (M)" },
        { "cplusfr169AU",       EC_M,    EC_M, { 0xEC, 0xA6, 0xE8, 0x4E, 0x10, 0x41, 0x6F }, { 0x10, 0x00, 0x28 }, { "TODAY"      }, { THEME_FILM,          0x00 }, "Canal+ 16/9 (M)" },
