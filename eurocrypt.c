...
const static ec_mode_t _ec_modes[] = {
	...
	{ "viasat220340008",   EC_M,    EC_M, { 0x48, 0x63, 0xC5, 0xB3, 0xDA, 0xE3, 0x29 }, { 0x00, 0x04, 0x08 }, { "01/12/2001" }, { 0xFF, 0x00 }, "TV1000 (M)" },
	{ "viasat22034000A",   EC_M,    EC_M, { 0x69, 0x36, 0x22, 0xCB, 0x33, 0xF3, 0x13 }, { 0x00, 0x04, 0x0A }, { "01/12/2001" }, { 0xFF, 0x00 }, "TV1000 (M)" },
	{ "viasat22034000E",   EC_M,    EC_M, { 0x69, 0x36, 0x22, 0xCB, 0x33, 0xF3, 0x13 }, { 0x00, 0x04, 0x0E }, { "01/12/2001" }, { 0xFF, 0x00 }, "TV1000 (M)" },
	...
	{ "viasat220341009",   EC_M,    EC_M, { 0x69, 0x36, 0x22, 0xCB, 0x33, 0xF3, 0x13 }, { 0x00, 0x04, 0x19 }, { "29/03/2000" }, { 0xFF, 0x00 }, "TV1000 (M)" },
        { "viasat2508",   EC_M,    EC_M, { 0x48, 0x63, 0xC5, 0xB3, 0xDA, 0xE3, 0x29 }, { 0x00, 0x04, 0x18 }, { "11/06/1998" }, { 0xFF, 0x00 }, "TV1000 (M)" },
        { "viasat6390",   EC_M,    EC_M, { 0x48, 0x63, 0xC5, 0xB3, 0xDA, 0xE3, 0x29 }, { 0x00, 0x04, 0x18 }, { "15/02/2000" }, { 0xFF, 0x00 }, "TV1000 (M)" },
	{ "viasat4465",   EC_M,    EC_M, { 0x48, 0x63, 0xC5, 0xB3, 0xDA, 0xE3, 0x29 }, { 0x00, 0x04, 0x18 }, { "19/09/1996" }, { 0xFF, 0x00 }, "TV1000 (M)" },
        { "tv32508",      EC_M,    EC_M, { 0x2B, 0x6A, 0x9E, 0xF3, 0xF5, 0xD4, 0x97 }, { 0x00, 0x04, 0x0C }, { "01/01/1999" }, { 0xFF, 0x00 }, "TV3 (M)" },
	{ "tv3update",    EC_M,    EC_M, { 0xE9, 0xF3, 0x34, 0x36, 0xB0, 0xBB, 0xF8 }, { 0x00, 0x04, 0x0C }, { "01/11/1995" }, { 0xFF, 0x00 }, "TV3 (AU - M)" },
	{ "VIA2508TV1000update",   EC_M,    EC_M, { 0x48, 0x63, 0xC5, 0xB3, 0xDA, 0xE3, 0x29 }, { 0x00, 0x04, 0x18 }, { "today"      }, { 0xFF, 0x00 }, "TV1000 (M)" },
	...
	{ "cplus0A",       EC_S,    EC_S, { 0XA9, 0X91, 0X86, 0X2C, 0X90, 0X6B, 0X9A }, { 0x00, 0x2B, 0x10 }, { "03/12/1998" }, { 0xFF, 0x00 }, "Canal+ (S2)" },
	{ "cplus1A",       EC_S,    EC_S, { 0x07, 0x3A, 0x0F, 0xB1, 0x4E, 0x49, 0x6D }, { 0x00, 0x2B, 0x11 }, { "03/12/1998" }, { 0xFF, 0x00 }, "Canal+ (S2)" },
	{ "cplus2A",       EC_S,    EC_S, { 0xA3, 0x53, 0x0C, 0x12, 0x55, 0xA3, 0x59 }, { 0x00, 0x2B, 0x12 }, { "03/12/1998" }, { 0xFF, 0x00 }, "Canal+ (S2)" },
	{ "cplus3A",       EC_S,    EC_S, { 0x76, 0xBF, 0x8E, 0xF4, 0xA1, 0x65, 0xB4 }, { 0x00, 0x2B, 0x13 }, { "03/12/1998" }, { 0xFF, 0x00 }, "Canal+ (S2)" },
	{ "cplus3ddA",     EC_3DES, EC_3DES, { 0x07, 0x3A, 0x0F, 0xB1, 0x4E, 0x49, 0x6D,   /* Key 01 and key 02 - index key D */
	                               0xA3, 0x53, 0x0C, 0x12, 0x55, 0xA3, 0x59 }, { 0x00, 0x2B, 0x1D }, { "03/12/1998" }, { 0xFF, 0x00 }, "Canal+ (3DES)" },
	{ "cplus3deA",     EC_3DES, EC_3DES, { 0xA3, 0x53, 0x0C, 0x12, 0x55, 0xA3, 0x59,   /* Key 02 and key 03 - index key E */
	                               0x76, 0xBF, 0x8E, 0xF4, 0xA1, 0x65, 0xB4 }, { 0x00, 0x2B, 0x1E }, { "03/12/1998" }, { 0xFF, 0x00 }, "Canal+ (3DES)" },
	{ "cplus0B",      EC_S,    EC_S, { 0XA9, 0X91, 0X86, 0X2C, 0X90, 0X6B, 0X9A }, { 0x00, 0x2B, 0x10 }, { "25/08/1998" }, { 0xFF, 0x00 }, "Canal+ (S2)" },                               
	{ "cplus1B",      EC_S,    EC_S, { 0XA9, 0X1B, 0X08, 0X0E, 0XFE, 0X69, 0XD6 }, { 0x00, 0x2B, 0x11 }, { "25/08/1998" }, { 0xFF, 0x00 }, "Canal+ (S2)" },
	{ "cplus2B",      EC_S,    EC_S, { 0X71, 0X77, 0X7D, 0X16, 0X54, 0X71, 0XA3 }, { 0x00, 0x2B, 0x12 }, { "25/08/1998" }, { 0xFF, 0x00 }, "Canal+ (S2)" },
	{ "cplus3B",      EC_S,    EC_S, { 0X07, 0XA3, 0X6C, 0XF8, 0X64, 0X37, 0XF4 }, { 0x00, 0x2B, 0x13 }, { "25/08/1998" }, { 0xFF, 0x00 }, "Canal+ (S2)" },
	{ "cplus3ddB ",   EC_3DES, EC_3DES, { 0XA9, 0X1B, 0X08, 0X0E, 0XFE, 0X69, 0XD6,   /* Key 01 and key 02 - index key D */
	                               0X71, 0X77, 0X7D, 0X16, 0X54, 0X71, 0XA3 }, { 0x00, 0x2B, 0x1D }, { "25/08/1998" }, { 0xFF, 0x00 }, "Canal+ (3DES)" },
	{ "cplus3deB",    EC_3DES, EC_3DES, { 0xA3, 0x53, 0x0C, 0x12, 0x55, 0xA3, 0x59,   /* Key 02 and key 03 - index key E */
	                               0x76, 0xBF, 0x8E, 0xF4, 0xA1, 0x65, 0xB4 }, { 0x00, 0x2B, 0x1E }, { "25/08/1998" }, { 0xFF, 0x00 }, "Canal+ (3DES)" },
	{ "cplus0C",      EC_S,    EC_S, { 0XA9, 0X91, 0X86, 0X2C, 0X90, 0X6B, 0X9A }, { 0x00, 0x2B, 0x10 }, { "13/01/1999" }, { 0xFF, 0x00 }, "Canal+ (S2)" },                               
	{ "cplus1C",      EC_S,    EC_S, { 0XA9, 0X1B, 0X08, 0X0E, 0XFE, 0X69, 0XD6 }, { 0x00, 0x2B, 0x11 }, { "13/01/1999" }, { 0xFF, 0x00 }, "Canal+ (S2)" },
	{ "cplus2C",      EC_S,    EC_S, { 0X71, 0X77, 0X7D, 0X16, 0X54, 0X71, 0XA3 }, { 0x00, 0x2B, 0x12 }, { "13/01/1999" }, { 0xFF, 0x00 }, "Canal+ (S2)" },
	{ "cplus3C",      EC_S,    EC_S, { 0X07, 0XA3, 0X6C, 0XF8, 0X64, 0X37, 0XF4 }, { 0x00, 0x2B, 0x13 }, { "13/01/1999" }, { 0xFF, 0x00 }, "Canal+ (S2)" },
	{ "cplus3ddC ",   EC_3DES, EC_3DES, { 0XA9, 0X1B, 0X08, 0X0E, 0XFE, 0X69, 0XD6,   /* Key 01 and key 02 - index key D */
	                               0X71, 0X77, 0X7D, 0X16, 0X54, 0X71, 0XA3 }, { 0x00, 0x2B, 0x1D }, { "13/01/1999" }, { 0xFF, 0x00 }, "Canal+ (3DES)" },
	{ "cplus3deC",    EC_3DES, EC_3DES, { 0xA3, 0x53, 0x0C, 0x12, 0x55, 0xA3, 0x59,   /* Key 02 and key 03 - index key E */
	                               0x76, 0xBF, 0x8E, 0xF4, 0xA1, 0x65, 0xB4 }, { 0x00, 0x2B, 0x1E }, { "13/01/1999" }, { 0xFF, 0x00 }, "Canal+ (3DES)" },
	{ "cplus0D",      EC_S,    EC_S, { 0XA9, 0X91, 0X86, 0X2C, 0X90, 0X6B, 0X9A }, { 0x00, 0x2B, 0x10 }, { "13/01/1999" }, { 0xFF, 0x00 }, "Canal+ (S2)" },                               
	{ "cplus1D",      EC_S,    EC_S, { 0XA9, 0X1B, 0X08, 0X0E, 0XFE, 0X69, 0XD6 }, { 0x00, 0x2B, 0x11 }, { "13/01/1999" }, { 0xFF, 0x00 }, "Canal+ (S2)" },
	{ "cplus2D",      EC_S,    EC_S, { 0X71, 0X77, 0X7D, 0X16, 0X54, 0X71, 0XA3 }, { 0x00, 0x2B, 0x12 }, { "13/01/1999" }, { 0xFF, 0x00 }, "Canal+ (S2)" },
	{ "cplus3D",      EC_S,    EC_S, { 0X07, 0XA3, 0X6C, 0XF8, 0X64, 0X37, 0XF4 }, { 0x00, 0x2B, 0x13 }, { "13/01/1999" }, { 0xFF, 0x00 }, "Canal+ (S2)" },
	{ "cplus3ddD ",   EC_3DES, EC_3DES, { 0XA9, 0X1B, 0X08, 0X0E, 0XFE, 0X69, 0XD6,   /* Key 01 and key 02 - index key D */
	                               0X71, 0X77, 0X7D, 0X16, 0X54, 0X71, 0XA3 }, { 0x00, 0x2B, 0x1D }, { "13/01/1999" }, { 0xFF, 0x00 }, "Canal+ (3DES)" },
	{ "cplus3deD",    EC_3DES, EC_3DES, { 0xA3, 0x53, 0x0C, 0x12, 0x55, 0xA3, 0x59,   /* Key 02 and key 03 - index key E */
	                               0x76, 0xBF, 0x8E, 0xF4, 0xA1, 0x65, 0xB4 }, { 0x00, 0x2B, 0x1E }, { "13/01/1999" }, { 0xFF, 0x00 }, "Canal+ (3DES)" },
	{ "cplus0E",      EC_S,    EC_S, { 0XA9, 0X91, 0X86, 0X2C, 0X90, 0X6B, 0X9A }, { 0x00, 0x2B, 0x10 }, { "13/01/1999" }, { 0xFF, 0x00 }, "Canal+ (S2)" },                               
	{ "cplus1E",      EC_S,    EC_S, { 0XA9, 0X1B, 0X08, 0X0E, 0XFE, 0X69, 0XD6 }, { 0x00, 0x2B, 0x11 }, { "13/01/1999" }, { 0xFF, 0x00 }, "Canal+ (S2)" },
	{ "cplus2E",      EC_S,    EC_S, { 0X71, 0X77, 0X7D, 0X16, 0X54, 0X71, 0XA3 }, { 0x00, 0x2B, 0x12 }, { "13/01/1999" }, { 0xFF, 0x00 }, "Canal+ (S2)" },
	{ "cplus3E",      EC_S,    EC_S, { 0X07, 0XA3, 0X6C, 0XF8, 0X64, 0X37, 0XF4 }, { 0x00, 0x2B, 0x13 }, { "13/01/1999" }, { 0xFF, 0x00 }, "Canal+ (S2)" },
	{ "cplus3ddE ",   EC_3DES, EC_3DES, { 0XA9, 0X1B, 0X08, 0X0E, 0XFE, 0X69, 0XD6,   /* Key 01 and key 02 - index key D */
	                               0X71, 0X77, 0X7D, 0X16, 0X54, 0X71, 0XA3 }, { 0x00, 0x2B, 0x1D }, { "13/01/1999" }, { 0xFF, 0x00 }, "Canal+ (3DES)" },
	{ "cplus3deE",    EC_3DES, EC_3DES, { 0xA3, 0x53, 0x0C, 0x12, 0x55, 0xA3, 0x59,   /* Key 02 and key 03 - index key E */
	                               0x76, 0xBF, 0x8E, 0xF4, 0xA1, 0x65, 0xB4 }, { 0x00, 0x2B, 0x1E }, { "13/01/1999" }, { 0xFF, 0x00 }, "Canal+ (3DES)" },
	...
	{ "rdv",          EC_S,    EC_S, { 0xFE, 0x6D, 0x9A, 0xBB, 0xEB, 0x97, 0xFB }, { 0x00, 0x2D, 0x93 }, { "01/12/1998" }, { 0xFF, 0x00 }, "RDV (S2)" },
        ...
        { "rdv1",         EC_S,    EC_S, { 0xFE, 0x6D, 0x9A, 0xBB, 0xEB, 0x97, 0xFB }, { 0x00, 0x2D, 0x11 }, { "01/12/1998" }, { 0xFF, 0x00 }, "RDV (S2)" },
        { "rdv2",         EC_S,    EC_S, { 0xFE, 0x6D, 0x9A, 0xBB, 0xEB, 0x97, 0xFB }, { 0x00, 0x2D, 0x83 }, { "01/12/1998" }, { 0xFF, 0x00 }, "RDV (S2)" },
        { "rdv3",         EC_S,    EC_S, { 0xFE, 0x6D, 0x9A, 0xBB, 0xEB, 0x97, 0xFB }, { 0x00, 0x2D, 0x81 }, { "01/12/1998" }, { 0xFF, 0x00 }, "RDV (S2)" },
	{ NULL } 
};
