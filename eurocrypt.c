...
const static ec_mode_t _ec_modes[] = {
	...
	{ "nrk2866475200",      EC_S,    EC_S, { 0xE7, 0x19, 0x5B, 0x7C, 0x47, 0xF4, 0x66 }, { 0x47, 0x52, 0x00 }, { "25/06/1997" }, { 0x00, 0x02 }, "NRK (S2)" },
	{ "tv22866475100",      EC_S,    EC_S, { 0x70, 0xBF, 0x6E, 0x51, 0x9F, 0xB8, 0xA6 }, { 0x47, 0x51, 0x00 }, { "25/06/1997" }, { 0x00, 0x02 }, "TV2 Norway (S2)" },
	{ "nrk4588475200",      EC_S,    EC_S, { 0xE7, 0x19, 0x5B, 0x7C, 0x47, 0xF4, 0x66 }, { 0x47, 0x52, 0x00 }, { "25/06/1997" }, { 0x00, 0x02 }, "NRK (S2)" },
	{ "tv24588475100",      EC_S,    EC_S, { 0x70, 0xBF, 0x6E, 0x51, 0x9F, 0xB8, 0xA6 }, { 0x47, 0x51, 0x00 }, { "25/06/1997" }, { 0x00, 0x02 }, "TV2 Norway (S2)" },
	{ "nrk7351475200",      EC_S,    EC_S, { 0xE7, 0x19, 0x5B, 0x7C, 0x47, 0xF4, 0x66 }, { 0x47, 0x52, 0x00 }, { "25/06/1997" }, { 0x00, 0x02 }, "NRK (S2)" },
	{ "tv27351475100",      EC_S,    EC_S, { 0x70, 0xBF, 0x6E, 0x51, 0x9F, 0xB8, 0xA6 }, { 0x47, 0x51, 0x00 }, { "25/06/1997" }, { 0x00, 0x02 }, "TV2 Norway (S2)" },
	{ "tv25581475100",      EC_S,    EC_S, { 0x70, 0xBF, 0x6E, 0x51, 0x9F, 0xB8, 0xA6 }, { 0x47, 0x52, 0x00 }, { "25/06/1997" }, { 0x00, 0x02 }, "TV2 Norway (S2)" },
	{ "tv25270475100",      EC_S,    EC_S, { 0x70, 0xBF, 0x6E, 0x51, 0x9F, 0xB8, 0xA6 }, { 0x47, 0x51, 0x00 }, { "25/06/1997" }, { 0x00, 0x02 }, "TV2 Norway (S2)" },
	{ "tv25581002B68",      EC_S,    EC_S, { 0x70, 0xBF, 0x6E, 0x51, 0x9F, 0xB8, 0xA6 }, { 0x00, 0x2B, 0x68 }, { "25/06/1997" }, { 0x00, 0x02 }, "TV2 Norway (S2)" },
	{ "tv25270002B68",      EC_S,    EC_S, { 0x70, 0xBF, 0x6E, 0x51, 0x9F, 0xB8, 0xA6 }, { 0x00, 0x2B, 0x68 }, { "25/06/1997" }, { 0x00, 0x02 }, "TV2 Norway (S2)" },
	{ "ctv9683000438",      EC_M,    EC_M, { 0x84, 0x66, 0x30, 0xE4, 0xDA, 0xFA, 0x23 }, { 0x00, 0x04, 0x38 }, { "01/04/1996" }, { 0xFF, 0x00 }, "CTV (M)" },
	{ "ctv2886000438",      EC_M,    EC_M, { 0x84, 0x66, 0x30, 0xE4, 0xDA, 0xFA, 0x23 }, { 0x00, 0x04, 0x38 }, { "01/04/1996" }, { 0xFF, 0x00 }, "CTV (M)" },
	{ "ctv9594000438",      EC_M,    EC_M, { 0x84, 0x66, 0x30, 0xE4, 0xDA, 0xFA, 0x23 }, { 0x00, 0x04, 0x38 }, { "18/12/1997" }, { 0xFF, 0x00 }, "CTV (M)" },
	...
	{ "viasat220300040CAU", EC_M,    EC_M, { 0xE9, 0xF3, 0x34, 0x36, 0xB0, 0xBB, 0xF8 }, { 0x00, 0x04, 0x0C }, { "today"      }, { 0xFF, 0x00 }, "TV3 (AU - M)" },
	{ "viasat220300041CAU", EC_M,    EC_M, { 0xE9, 0xF3, 0x34, 0x36, 0xB0, 0xBB, 0xF8 }, { 0x00, 0x04, 0x1C }, { "today"      }, { 0xFF, 0x00 }, "TV1000 (AU - M)" },
...
const static em_mode_t _em_modes[] = {
	{ "viasat220300040CAU",    EC_M, EC_M, { 0x98, 0x44, 0x0A, 0x05, 0x9B, 0x4A, 0xF7 }, { 0x00, 0x04, 0x04 }, { 0x21, 0x7B, 0x90 }, { 0, 0, 0, 0 }, EMMG },
	{ "viasat220300041CAU",    EC_M, EC_M, { 0x0B, 0xEC, 0x0E, 0x83, 0xE5, 0x0B, 0xC8 }, { 0x00, 0x04, 0x14 }, { 0x44, 0x21, 0x7B }, { 0, 0, 0, 0 }, EMMG },
	{ "filmnet4528002808AU",   EC_M, EC_M, { 0x41, 0xC1, 0xA2, 0x69, 0x6B, 0xEE, 0x23 }, { 0x00, 0x28, 0x00 }, { 0x04, 0x34, 0x42 }, { 0, 0, 0, 0 }, EMMG },
	{ "tv22866475200AU",       EC_S, EC_S, { 0x70, 0xBF, 0x6E, 0x51, 0x9F, 0xB8, 0xA6 }, { 0x47, 0x51, 0x00 }, { 0x09, 0x27, 0xCE }, { 0, 0, 0, 0 }, EMMG },
	{ "cplusfr43AU",           EC_M, EC_M, { 0x39, 0x74, 0xD7, 0xC1, 0x3F, 0x1B, 0x0D }, { 0x10, 0x00, 0x15 }, { 0x04, 0x93, 0xF2 }, { 0, 0, 0, 0 }, EMMG },
	{ "cplusfr169AU",          EC_M, EC_M, { 0x12, 0x37, 0x5A, 0x43, 0xE4, 0xA1, 0x48 }, { 0x10, 0x00, 0x26 }, { 0x04, 0x93, 0xF2 }, { 0, 0, 0, 0 }, EMMG },
	{ "cinecfrAU",             EC_M, EC_M, { 0x89, 0x61, 0x30, 0x3B, 0x3F, 0x7B, 0xA8 }, { 0x10, 0x00, 0x36 }, { 0x04, 0x93, 0xF2 }, { 0, 0, 0, 0 }, EMMG },
	{ "cplusfr43AUABSAT",      EC_M, EC_M, { 0x39, 0x74, 0xD7, 0xC1, 0x3F, 0x1B, 0x0D }, { 0x10, 0x00, 0x15 }, { 0x04, 0x93, 0xF2 }, { 0, 0, 0, 0 }, EMMG },
	{ NULL } 
};
