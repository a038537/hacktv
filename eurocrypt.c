...
const static ec_mode_t _ec_modes[] = {
	...
	{ "viasat4465",   EC_M,    EC_M, { 0x48, 0x63, 0xC5, 0xB3, 0xDA, 0xE3, 0x29 }, { 0x00, 0x04, 0x18 }, { "19/09/1996" }, { 0xFF, 0x00 }, "TV1000 (M)" },
        { "tv30758",      EC_M,    EC_M, { 0x73, 0x13, 0xC6, 0x8A, 0x35, 0xFD, 0xE7 }, { 0x00, 0x04, 0x0C }, { "01/01/1999" }, { 0xFF, 0x00 }, "TV3 (M)" },
	...
	{ "filmnetctv",   EC_M,    EC_M, { 0x21, 0x12, 0x31, 0x35, 0x8A, 0xC3, 0x4F }, { 0x00, 0x28, 0x08 }, { "25/03/1995" }, { 0xFF, 0x00 }, "FilmNet (M)" },
