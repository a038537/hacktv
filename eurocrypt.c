...
const static ec_mode_t _ec_modes[] = {
	...
	{ "tv22866475200AU",    EC_S,    EC_S, { 0x70, 0xBF, 0x6E, 0x51, 0x9F, 0xB8, 0xA6 }, { 0x47, 0x51, 0x00 }, { "today"      }, { 0xFF, 0x00 }, "TV2 Norway (AU - S2)" },
	...
	{ "filmnet8754002808AU",EC_M,    EC_M, { 0x21, 0x12, 0x31, 0x35, 0x8A, 0xC3, 0x4F }, { 0x00, 0x28, 0x08 }, { "today"      }, { 0xFF, 0x00 }, "Filmnet (AU - M)" },
...
const static em_mode_t _em_modes[] = {
	...
	{ "filmnet8754002808AU",   EC_M, EC_M, { 0xF7, 0x8A, 0xDF, 0xB7, 0x85, 0xD1, 0x0F }, { 0x00, 0x28, 0x03 }, { 0xC4, 0xB3, 0xD5 }, { 0, 0, 0, 0 }, EMMG },
