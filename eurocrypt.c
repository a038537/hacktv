...
const static ec_mode_t _ec_modes[] = {
	...
	{ "viasat395541008",   EC_M,    EC_M, { 0x48, 0x63, 0xC5, 0xB3, 0xDA, 0xE3, 0x29 }, { 0x00, 0x04, 0x18 }, { "01/10/1999" }, { 0xFF, 0x00 }, "TV1000 (M)" },
	{ "viasat39554100C",   EC_M,    EC_M, { 0x2C, 0xBE, 0x80, 0x40, 0x30, 0x64, 0xA4 }, { 0x00, 0x04, 0x1C }, { "01/10/1999" }, { 0xFF, 0x00 }, "TV1000 (M)" },
	{ "viasat279641008",   EC_M,    EC_M, { 0x48, 0x63, 0xC5, 0xB3, 0xDA, 0xE3, 0x29 }, { 0x00, 0x04, 0x18 }, { "02/11/1998" }, { 0xFF, 0x00 }, "TV1000 (M)" },
	{ "viasat27964100C",   EC_M,    EC_M, { 0x2C, 0xBE, 0x80, 0x40, 0x30, 0x64, 0xA4 }, { 0x00, 0x04, 0x1C }, { "02/11/1998" }, { 0xFF, 0x00 }, "TV1000 (M)" },
	...
	{ "viasat2203tv3update",    EC_M,    EC_M, { 0xE9, 0xF3, 0x34, 0x36, 0xB0, 0xBB, 0xF8 }, { 0x00, 0x04, 0x0C }, { "today"      }, { 0xFF, 0x00 }, "TV3 (AU - M)" },
	{ "viasat2203tv1000update",    EC_M,    EC_M, { 0xE9, 0xF3, 0x34, 0x36, 0xB0, 0xBB, 0xF8 }, { 0x00, 0x04, 0x1C }, { "today"      }, { 0xFF, 0x00 }, "TV1000 (AU - M)" },
	{ "filmnet",      EC_M,    EC_M, { 0x21, 0x12, 0x31, 0x35, 0x8A, 0xC3, 0x4F }, { 0x00, 0x28, 0x08 }, { "28/02/1993" }, { 0xFF, 0x00 }, "FilmNet (M)" },
	{ "filmnet786908",  EC_M,    EC_M, { 0x21, 0x12, 0x31, 0x35, 0x8A, 0xC3, 0x4F }, { 0x00, 0x28, 0x08 }, { "26/06/1994" }, { 0xFF, 0x00 }, "FilmNet (M)" },
	{ "filmnet786909",  EC_M,    EC_M, { 0x33, 0x22, 0x44, 0x53, 0xFF, 0x58, 0x50 }, { 0x00, 0x28, 0x09 }, { "26/06/1994" }, { 0xFF, 0x00 }, "FilmNet (M)" },
	{ "filmnet78690A",  EC_M,    EC_M, { 0xF2, 0x58, 0x27, 0x33, 0xE5, 0x79, 0x61 }, { 0x00, 0x28, 0x0A }, { "26/06/1994" }, { 0xFF, 0x00 }, "FilmNet (M)" },
	{ "filmnet78690B",  EC_M,    EC_M, { 0x5E, 0xEC, 0xF3, 0x5B, 0x54, 0x6E, 0x88 }, { 0x00, 0x28, 0x0B }, { "26/06/1994" }, { 0xFF, 0x00 }, "FilmNet (M)" },
	{ "filmnet78690C",  EC_M,    EC_M, { 0xCD, 0xEF, 0x73, 0x53, 0x4E, 0x7D, 0x94 }, { 0x00, 0x28, 0x0C }, { "26/06/1994" }, { 0xFF, 0x00 }, "FilmNet (M)" },
	{ "filmnet78690D",  EC_M,    EC_M, { 0x35, 0x5B, 0x37, 0x04, 0xBB, 0x44, 0x0E }, { 0x00, 0x28, 0x0D }, { "26/06/1994" }, { 0xFF, 0x00 }, "FilmNet (M)" },
	...
	{ "filmnet8754update",    EC_M,    EC_M, { 0x21, 0x12, 0x31, 0x35, 0x8A, 0xC3, 0x4F }, { 0x00, 0x28, 0x08 }, { "today"      }, { 0xFF, 0x00 }, "Filmnet (AU - M)" },
	...
	{ "cinecfr",      EC_M,    EC_M, { 0xEC, 0xA6, 0xE8, 0x4E, 0x10, 0x41, 0x6F }, { 0x10, 0x00, 0x38 }, { "today"      }, { 0xFF, 0x00 }, "Cine Cinemas (M)" },
	{ NULL } 
};

/* Data for EC controlled-access EMMs */
const static em_mode_t _em_modes[] = {
	{ "viasat2203tv3update",    EC_M, EC_M, { 0x98, 0x44, 0x0A, 0x05, 0x9B, 0x4A, 0xF7 }, { 0x00, 0x04, 0x04 }, { 0x21, 0x7B, 0x90 }, { 0, 0, 0, 0 }, EMMG },
	{ "viasat2203tv1000update",    EC_M, EC_M, { 0x0B, 0xEC, 0x0E, 0x83, 0xE5, 0x0B, 0xC8 }, { 0x00, 0x04, 0x14 }, { 0x44, 0x21, 0x7B }, { 0, 0, 0, 0 }, EMMG },
	{ "filmnet8754update",    EC_M, EC_M, { 0xF7, 0x8A, 0xDF, 0xB7, 0x85, 0xD1, 0x0F }, { 0x00, 0x28, 0x03 }, { 0xC4, 0xB3, 0xD5 }, { 0, 0, 0, 0 }, EMMG },
	{ "cplusfr43",    EC_M, EC_M, { 0x39, 0x74, 0xD7, 0xC1, 0x3F, 0x1B, 0x0D }, { 0x10, 0x00, 0x15 }, { 0x04, 0x93, 0xF2 }, { 0, 0, 0, 0 }, EMMG },
	{ "cplusfr169",   EC_M, EC_M, { 0x12, 0x37, 0x5A, 0x43, 0xE4, 0xA1, 0x48 }, { 0x10, 0x00, 0x26 }, { 0x04, 0x93, 0xF2 }, { 0, 0, 0, 0 }, EMMG },
	{ "cinecfr",      EC_M, EC_M, { 0x89, 0x61, 0x30, 0x3B, 0x3F, 0x7B, 0xA8 }, { 0x10, 0x00, 0x36 }, { 0x04, 0x93, 0xF2 }, { 0, 0, 0, 0 }, EMMG },
	{ NULL } 
};
