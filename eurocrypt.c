...
const static ec_mode_t _ec_modes[] = {
	...
	{ "filmnet4528002800AU",EC_M,    EC_M, { 0x99, 0x01, 0x00, 0x5C, 0x63, 0xF8, 0x50 }, { 0x00, 0x28, 0x08 }, { "today"      }, { 0xFF, 0x00 }, "Filmnet (AU - M)" },
...
const static em_mode_t _em_modes[] = {
	...
	{ "filmnet4528002800AU",   EC_M, EC_M, { 0x1A, 0xDA, 0x44, 0x3E, 0xBA, 0xE2, 0xAC }, { 0x00, 0x28, 0x00 }, { 0x04, 0x34, 0x42 }, { 0, 0, 0, 0 }, EMMG },
