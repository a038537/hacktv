...
const static ec_mode_t _ec_modes[] = {
	...
	{ "cplus0",       EC_S,    EC_S, { 0XA9, 0X91, 0X86, 0X2C, 0X90, 0X6B, 0X9A }, { 0x00, 0x2B, 0x10 }, { "03/12/1998" }, { 0xFF, 0x00 }, "Canal+ (S2)" },
	{ "cplus1",       EC_S,    EC_S, { 0x07, 0x3A, 0x0F, 0xB1, 0x4E, 0x49, 0x6D }, { 0x00, 0x2B, 0x11 }, { "03/12/1998" }, { 0xFF, 0x00 }, "Canal+ (S2)" },
	{ "cplus2",       EC_S,    EC_S, { 0xA3, 0x53, 0x0C, 0x12, 0x55, 0xA3, 0x59 }, { 0x00, 0x2B, 0x12 }, { "03/12/1998" }, { 0xFF, 0x00 }, "Canal+ (S2)" },
	{ "cplus3",       EC_S,    EC_S, { 0x76, 0xBF, 0x8E, 0xF4, 0xA1, 0x65, 0xB4 }, { 0x00, 0x2B, 0x13 }, { "03/12/1998" }, { 0xFF, 0x00 }, "Canal+ (S2)" },
	{ "cplus3dd",     EC_3DES, EC_3DES, { 0x07, 0x3A, 0x0F, 0xB1, 0x4E, 0x49, 0x6D,   /* Key 01 and key 02 - index key D */
	                               0xA3, 0x53, 0x0C, 0x12, 0x55, 0xA3, 0x59 }, { 0x00, 0x2B, 0x1D }, { "03/12/1998" }, { 0xFF, 0x00 }, "Canal+ (3DES)" },
	{ "cplus3de",     EC_3DES, EC_3DES, { 0xA3, 0x53, 0x0C, 0x12, 0x55, 0xA3, 0x59,   /* Key 02 and key 03 - index key E */
