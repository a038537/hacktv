...
const static ec_mode_t _ec_modes[] = {
	...
	{ "tv3update",    EC_M,    EC_M, { 0xE9, 0xF3, 0x34, 0x36, 0xB0, 0xBB, 0xF8 }, { 0x00, 0x04, 0x0C }, { "today"      }, { 0xFF, 0x00 }, "TV3 (AU - M)" },
	{ "tv1000update",    EC_M,    EC_M, { 0xE9, 0xF3, 0x34, 0x36, 0xB0, 0xBB, 0xF8 }, { 0x00, 0x04, 0x1C }, { "today"      }, { 0xFF, 0x00 }, "TV1000 (AU - M)" },
	...
	{ "filmnetupdate",    EC_M,    EC_M, { 0x21, 0x12, 0x31, 0x35, 0x8A, 0xC3, 0x4F }, { 0x00, 0x28, 0x08 }, { "today"      }, { 0xFF, 0x00 }, "Filmnet (AU - M)" },
	...
	{ "VISIOPASScplusfr43",    EC_M,    EC_M, { 0x69, 0x41, 0x2D, 0x4C, 0x56, 0x28, 0xCF }, { 0x10, 0x00, 0x18 }, { "today"      }, { 0xFF, 0x00 }, "Canal+ 4/3 (M)" },
	{ NULL } 
};
...
const static em_mode_t _em_modes[] = {
	...
	{ "tv1000update",    EC_M, EC_M, { 0x0B, 0xEC, 0x0E, 0x83, 0xE5, 0x0B, 0xC8 }, { 0x00, 0x04, 0x14 }, { 0x44, 0x21, 0x7B }, { 0, 0, 0, 0 }, EMMG },
	{ "filmnetupdate",    EC_M, EC_M, { 0xDB, 0xB3, 0xEB, 0x03, 0x1D, 0x9B, 0x37 }, { 0x00, 0x28, 0x04 }, { 0xC4, 0xB5, 0x2F }, { 0, 0, 0, 0 }, EMMG },
	...
	{ "cinecfr",      EC_M, EC_M, { 0x89, 0x61, 0x30, 0x3B, 0x3F, 0x7B, 0xA8 }, { 0x10, 0x00, 0x36 }, { 0x00, 0x00, 0x00 }, { 0, 0, 0, 0 }, EMMG },
	{ "VISIOPASScplusfr43",    EC_M, EC_M, { 0x39, 0x74, 0xD7, 0xC1, 0x3F, 0x1B, 0x0D }, { 0x10, 0x00, 0x15 }, { 0x01, 0x29, 0x7C }, { 0, 0, 0, 0 }, EMMG },
	{ NULL } 
};
