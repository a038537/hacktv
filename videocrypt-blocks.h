...
static _vc_block_t _sky09nano_blocks[] = {
	...
	},
	{
		...
		{
 			{ 0x20,0x00,0x78,020,0x20,0x20,0x53,0x4b,0x59,0x20,0x30,0x39,0x20,0x20,0x20,0x20,0x4e,0x41,0x4e,0x4f,0x20,0x20,0x4d,0x4f,0x44,0x45,0x20 },
 			{ }, { }, { }, { },
...
/* requires an active Sky 10 (0A) series card to decode SKY ONE */
static _vc_block_t _sky10_blocks[] = {
	...
	},
	{
		0x07, 0x7DE3581091A306E5UL,
		{
			...
			{ 0x20,0x00,0x77,0x20,0x20,0x53,0x4b,0x59,0x20,0x4f,0x4e,0x45 },
			{ }, { }, { }, { },
...
/* requires an active Sky 10 (0A) series card with PPV enabled to decode  SKY PPV*/
...
static _vc_block_t _sky10ppv_blocks[] = {
	...
	},
	{
		0x07, 0x20222974682EFF97UL,
		{
			...
			{ 0x20,0x00,0x77,0x20,0x20,0x53,0x4b,0x59,0x20,0x50,0x50,0x56 },
 			{ }, { }, { }, { },
...
/* requires an active Sky 11 series card to decode SKY PREMIER */
static _vc_block_t _sky11_blocks[] = {
	...
	},
	{
		0x07, 0xF9885DA50770B80UL,
		{
			...
			{ 0x20,0x00,0x77,0x20,0x53,0x4b,0x59,0x20,0x50,0x52,0x45,0x4d,0x49,0x45,0x52 },
 			{ }, { }, { }, { },
